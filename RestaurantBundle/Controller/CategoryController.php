...
use Su\RestaurantBundle\Form\CategoryType;
use Su\RestaurantBundle\Form\CategoryFilterType;
...
class CategoryController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('SuRestaurantBundle:Category')->createQueryBuilder('e');
    ...
    */
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('category_show', array('id' => $entity->getCategoryId())));
        }
